...
function Form(props) {
    ...
    const handleClikButton = () => {
        ...
        const val = { date, time, keluar, task}
        props.func(val)
        clear()
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="p-3 mb-2 bg-primary-subtle text-primary-emphasis">
                            <fieldset>
                                <legend>Input Pengeluaran</legend>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="exampleFormControlInput3" class="form-label">Uang Keluar</label>
                                    <input type="number" class="form-control" id="exampleFormControlInput3" placeholder="0"
                                    value={keluar} onChange={changeMasuk}/>
                                </div>
                                <div class="mb-3">
